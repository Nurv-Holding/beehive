...
function WayOfBeing() {
    ...
    return (
        <div className='flex flex-row'>
            ...
            <Link
                   to="/formwayofbeing" className="w-full aspect-square rounded-lg bg-white text-[#5500C3] hover:bg-[#5500C3] hover:text-white flex justify-center text-center items-center text-4xl p-2"
                >
                    +
                </Link>
            </div>
