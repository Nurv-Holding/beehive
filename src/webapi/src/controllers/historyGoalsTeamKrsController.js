...
const progectionHistoryGoalTeamKrByKr = async (req, res) => {
    ...
    gt.id as idGoalTeam, gt.name as nameGoalTeam, pgt.id as idProcessGoalsTeam, hgtk.note,
...
const getAllHistoryGoalTeamKrByKr = async (req, res) => {
